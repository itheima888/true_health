...
public class MessageConstant {
    public static final String SYSTEM_ERROR = "非法请求";
    public static final String SYSTEM_FAIL = "系统异常，请联系管理员";
    public static final String DELETE_CHECKITEM_FAIL = "删除检查项失败";
    public static final String DELETE_CHECKITEM_CHECKGROUP_FAIL = "检查项已经关联检查组，不能删除";
    public static final String DELETE_SETMEAL_CHECKGROUP_FAIL = "套餐已经关联检查组，不能删除";
